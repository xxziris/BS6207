...
2. If $\sigma'' \leq 0$, then we can't compare the values of $\sigma'$. Hence, we are unable to prove that $|\frac{\partial y^*}{\partial w_1}| > |\frac{\partial y}{\partial w_1}|$.
...
2. If $\sigma'' \leq 0$, then we can't compare the values of $\sigma'$. Hence, we are unable to prove that $|\frac{\partial y^*}{\partial b_1}| > |\frac{\partial y}{\partial b_1}|$.
